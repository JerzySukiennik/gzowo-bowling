...
export function showMyBalls(rootEl, balls, opts) {
  ...
  function renderList() {
    ...
    const topbar = el("div", "topbar topbar-back");
    const backArrow = el("button", "btn btn-ghost btn-back-arrow", "← " + t("common.back"));
    backArrow.addEventListener("click", () => { sfx("ui"); vib(10); commit(); if (typeof options.onClose === "function") options.onClose(); });
    topbar.append(backArrow, el("div", "logo-small", "GZOWO BOWLING 🎳"));
